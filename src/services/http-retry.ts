// HTTP retry middleware for the Google Ads client.
//
...
export interface RetryOptions {
  vendor: string;                  // e.g. "google_ads" — used for stderr log prefix
  envFlag: string;                 // e.g. "GOOGLE_ADS_NO_RETRY" — env var to disable
